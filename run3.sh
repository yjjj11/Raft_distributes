...
NODE_CONFIGS=(
    "0 127.0.0.1 8000 2 127.0.0.1:8001 127.0.0.1:8002"
    "1 127.0.0.1 8001 6 127.0.0.1:8000 127.0.0.1:8002"
    "2 127.0.0.1 8002 6 127.0.0.1:8001 127.0.0.1:8000"
)
# 程序执行文件路径
BIN_FILE="./bin/main"
# ===================== 全局变量 =====================
...
start_node() {
    ...
    # 启动节点，重定向日志
    echo "启动节点 $node_id ..."
    $BIN_FILE $node_id $ip $port $election_time $peers > ${LOG_DIR}/node${node_id}.log 2>&1 &
    local pid=$!
